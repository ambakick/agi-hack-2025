...
function WorkflowCanvas() {
  ...
  const handleTopicComplete = useCallback(
    (topic: string, format: PodcastFormat) => {
      ...
      // Add References node
      addNode('references', { x: 450, y: 200 }, {
  ...
  const handleReferencesComplete = useCallback(
    ...
    [state.topic, state.format, updateGenerationState, completeNode, addNode, expandNode, collapseNode]
  );
  ...
  const hasEditedNode = nodes.some((n) => !n.data.isCompleted && n.id !== 'topic');
      ...
      >
        ...
        <MiniMap
          ...
          nodeColor={(node) => {
            ...
            return colors[node.type || ''] || '#gray-400';
          }}
        />
        ...
        <Panel position="top-left" className="m-4">
          <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100 max-w-md">
            ...
            <h1 className="text-xl font-bold text-gray-900">Podcast Generator</h1>
        ...
        <Panel position="top-right" className="m-4">
          <div className="bg-white rounded-lg shadow-lg p-3 border border-gray-100">
            <div className="flex gap-2">
              {['Topic', 'References', 'Outline', 'Script', 'Audio'].map((label, idx) => {
