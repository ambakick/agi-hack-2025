      ...
      {loading ? (
        <div className="flex items-center justify-center py-8">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500">This may take 2-3 minutes</p>
          </div>
        </div>
      ) : audioUrl ? (
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 text-center border border-green-100">
            <div className="w-16 h-16 bg-green-500 bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-3">
              <Volume2 className="w-8 h-8 text-green-600" />
            </div>
            <h3 className="text-base font-semibold text-gray-900 mb-1">Your Podcast is Ready!</h3>
            <p className="text-xs text-gray-600 mb-4">
              Duration: ~{Math.round(data.script?.total_duration_seconds || 0 / 60)} minutes
            </p>
