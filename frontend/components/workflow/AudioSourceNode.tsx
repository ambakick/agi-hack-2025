...
interface AudioSourceNodeProps extends NodeProps {
...
export function AudioSourceNode({ id, data }: AudioSourceNodeProps) {
  ...
  return (
    ...
    >
      <div className="space-y-4">
        {!source ? (
          <>
            <p className="text-sm text-gray-300">Upload an audio file</p>
            <FileUploadZone
          ...
          <>
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              {source.file_url && (
                <audio controls src={source.file_url} className="w-full mb-3" />
              )}
